(function () {
    ...
    var patch = snabbdom.init([
      ...
      _class.default, // makes it easy to toggle classes
      props.default, // for setting properties on DOM elements
      style.default, // handles styling on elements with support for animations
      eventlisteners.default // attaches event listeners
    ]);

    var h$1 = h_1.default; // helper function for creating vnodes
